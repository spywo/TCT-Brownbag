        ...
        new Thread() {
            ...
            public void run() {
                ...
                String endpoint = MainCommunity.this.getConfigurationManager()
                                                    .getProperties("server.uri.http")
                                                    .concat("/message");
                Stomp stomp = new Stomp(endpoint, headersSetup, new ListenerWSNetwork() {
                    @Override
                ...
                stomp.subscribe(new Subscription("/topic/notification", new ListenerSubscription() {
                    ...
                    public void onMessage(Map<String, String> headers, final String body) {
                        ...
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                ItemListFragment lf = (ItemListFragment)(getFragmentManager().findFragmentById(R.id.notificationList));
