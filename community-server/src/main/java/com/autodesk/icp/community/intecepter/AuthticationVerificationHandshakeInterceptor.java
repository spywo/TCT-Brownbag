 ...
 * @author Oliver Wu
 */
public class AuthticationVerificationHandshakeInterceptor extends HttpSessionHandshakeInterceptor {
    public AuthticationVerificationHandshakeInterceptor() {
        super();
    }

    public AuthticationVerificationHandshakeInterceptor(Collection<String> attributeNames) {
